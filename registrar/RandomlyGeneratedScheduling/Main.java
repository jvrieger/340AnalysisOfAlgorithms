...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < allCourses.length; i++) {
                mycontent += String.format("%d\t%d\t%d\t%d", allCourses[i].getId(), allCourses[i].getRoom().getId(), allCourses[i].getTeacher().getTeacherId(), allCourses[i].getTime());
            ...
            long nano_estimated_Time3 = System.nanoTime();
            System.out.println("time: " + nano_estimated_Time/.000000001);
        }
